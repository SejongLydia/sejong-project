      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 ftco-animate">
          	<div>
          			<h2 class="mb-3">${ddto.name}</h2>
          			<p class="info"><span class="user">${ddto.kind}</span> | ${ddto.age} | <i class="fa fa-eye"></i> ${ddto.gender}</p>
		          	
		          	<div>
		              <img src="${pageContext.request.contextPath }/upload/${ddto.imgurl}" alt="" class="img-fluid">
		            </div>
		            ...
		            <div class="tag-widget post-tag-container mb-5 mt-5">
		              <div class="tagcloud" style="text-align: center;">
		                ...
		                <a href="newsmodify.do?bno=${ddto.bno}" class="tag-cloud-link">수정</a>
		                <a href="dogdelete.do?bno=${ddto.bno}" class="tag-cloud-link" onClick="return confirm('정말로 삭제할까요?')">삭제</a>
		              </div>
		            </div>
             </div>
