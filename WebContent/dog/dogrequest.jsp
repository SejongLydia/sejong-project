			...
			<div class="col-md-9 ftco-animate pb-5">
				<p class="breadcrumbs mb-2">
					<span class="mr-2"><a href="index.html">Home > <i
							class="ion-ios-arrow-forward"></i></a></span><span class="mr-2">강아지
						입양 > <i class="ion-ios-arrow-forward"></i>
					</span><span class="mr-2">입양 문의<i class="ion-ios-arrow-forward"></i></span>
				</p>
				<h1 class="mb-0 bread">강아지 입양문의</h1>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-6 text-center mb-5">
				<h2 class="heading-section">강아지 입양문의</h2>
			</div>
		</div>
		<div class="row justify-content-center">
			<div class="col-md-12">
						...
						<div class="col-md-7">
							<div class="contact-wrap w-100 p-md-5 p-4">
								...
								<form name="enter" method="post" enctype="multipart/form-data"
									action="enterwrite.do" onsubmit="return check()" id="enter"
									class="contactForm">
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label class="label" for="name">작성자</label> <input
										...
										<div class="col-md-12">
											<div class="form-group">
												<label class="label" for="title">제목</label> <input
													type="text" class="form-control" name="title" id="subject"
													placeholder="제목">
											</div>
										</div>
										<div class="col-md-12">
											<div class="form-group">
												<label class="label" for="title">희망 분양견</label>
												<img src="${pageContext.request.contextPath}/upload/${ddto.imgurl}">
											</div>
										</div>
										<div class="col-md-12">
											<div class="form-group">
										...
										<div class="col-md-12">
											<div class="form-group">
												<label class="label" for="imgurl">첨부파일</label> <input
													type="file" name="imgurl"
													accept="image/jpeg, image/png, image/jpg"
													class="form-control" id="isFile" style="color: gray;">
											</div>
										</div>
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<input type="button" value="목록" class="btn btn-primary"
													onClick="location.href='enter.do';">
