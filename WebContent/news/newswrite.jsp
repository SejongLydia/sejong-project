			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-md-6 text-center mb-5">
						<h2 class="heading-section">새소식</h2>
					</div>
				</div>
				<div class="row justify-content-center">
					<div class="col-md-12">
							...
							<div class="row no-gutters">
								<div class="col-md-7">
									<div class="contact-wrap w-100 p-md-5 p-4">
										...
										<form name="news" method="post" enctype="multipart/form-data" action="newswrite.do"  onsubmit="return check()" id="contactForm"  class="contactForm">
											<div class="row">
												<div class="col-md-6">
