          	...
          	<div>
		            ...
		            <div class="tag-widget post-tag-container mb-5 mt-5">
		              <div class="tagcloud" style="text-align: center;">
		                <a href="review.do" class="tag-cloud-link">목록</a>
		                <a href="reviewupdate.do?bno=${view.bno}" class="tag-cloud-link">수정</a>
		                <a href="reviewdelete.do?bno=${view.bno}" class="tag-cloud-link" onClick="return confirm('정말로 삭제할까요?')">삭제</a>
		              </div>
		            </div>
             </div>
...
<script>
	...
	function cmtWrite(){
		...
		function cmtUpdate(num){ //수정 버튼을 누르면 컨텐트 부분이 수정할 수 있게 <textarea>태그로 변함
			var output ="";						
	    	var logId = "${sessionScope.userid}";						
